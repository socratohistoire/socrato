...
export const STUDENT_PROGRESS_CONVERSATION_VERSION = 3 as const;
...
export type StudentProgressContract = StudentProgressContractBase & (
  ...
  | { schemaVersion: typeof STUDENT_PROGRESS_CONVERSATION_VERSION; questionRuntime: StudentQuestionRuntimeProgress[] }
);
