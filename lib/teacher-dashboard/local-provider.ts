  ...
  const activities = [
    {
      ...
      groupPortraits: [
        { id: "portrait-401", activityId: "activity-revision-01", name: "Groupe fictif 401", observation: "Les résultats montrent une bonne maîtrise des causes et conséquences de l’Acte d’union.", suggestion: "Suggestion fictive : Poursuivre sur les liens entre documents et contexte politique.", completedStudentCount: 21, targetedStudentCount: 24 },
