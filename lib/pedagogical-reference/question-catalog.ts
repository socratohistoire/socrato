...
export const ACTE_UNION_TIMELINE_PROTOTYPE_QUESTION = {
  ...
  expectedAnswer: "1837-1838 — Rébellions dans les deux Canadas; 1839 — Publication du rapport Durham; 1840 — Adoption de l’Acte d’Union; 1841 — Naissance de la Province du Canada; 1841-1842 — Alliance La Fontaine–Baldwin; 1848 — Avènement du gouvernement responsable.",
...
export const ACTE_UNION_TIMELINE_CAUSAL_DEVELOPMENT_QUESTION = {
  ...
  instruction: "Rédige une réponse d’environ 150 mots. Établis un lien entre chacune des six étapes : les Rébellions, le rapport Durham, l’adoption de l’Acte d’Union, la création de la Province du Canada, l’alliance réformiste de La Fontaine et Baldwin et l’avènement du gouvernement responsable.",
  expectedAnswer: "Les Rébellions de 1837-1838 révèlent l’ampleur de la crise politique et poussent le gouvernement britannique à enquêter. Dans son rapport de 1839, Durham recommande notamment l’union des deux Canadas et le gouvernement responsable. Le Parlement britannique adopte l’Acte d’Union en 1840, puis son entrée en vigueur crée la Province du Canada en 1841 sans rendre immédiatement l’exécutif responsable devant l’Assemblée. Dans cette assemblée commune, La Fontaine et Baldwin unissent les réformistes du Canada-Est et du Canada-Ouest afin de construire une majorité parlementaire. En 1848, leur alliance remporte les élections et le gouverneur Elgin les appelle à former un ministère soutenu par cette majorité. Le gouvernement responsable résulte donc d’une succession de transformations et de luttes politiques, et non de l’Acte d’Union seul.",
  historicalDocumentIds: [ACTE_UNION_STUDENT_TIMELINE.id],
  ...
  sourceIds: timelineSources.map(({ id }) => id),
  sourceCatalog: timelineSources,
  rationale: "La réponse développée permet de vérifier une chaîne causale nuancée reliant les six repères de la ligne du temps, notamment le rôle de l’alliance réformiste entre l’Union et le gouvernement responsable.",
  review: { documented: true, historicallyVerified: true, pedagogicallyVerified: true, biasAndLanguageReviewed: true, approvedBy: "David Hinse", approvedVersion: "1.0", approvedAt: "2026-08-02T00:00:00.000-04:00" },
} as const satisfies ApprovedQuestion;
