...
export const ACTE_UNION_STUDENT_TIMELINE = {
  ...
  historicalContext: "La frise relie les Rébellions, le rapport Durham, l’adoption de l’Acte d’Union, sa mise en application, la crise ministérielle de 1843 et l’avènement du gouvernement responsable en 1848.",
  operationIds: ["time_and_space", "relationships_between_facts", "causal_connections"] as const,
  observationGuide: ["Remettre les six étapes en ordre.", "Distinguer l’adoption de la loi en 1840 de son application en 1841.", "Expliquer comment la crise ministérielle de 1843 révèle l’absence d’un gouvernement pleinement responsable.", "Relier chaque image à l’événement qu’elle représente."],
  ...
  entries: [
    ...
    { date: "1843", phase: "L’instabilité politique", title: "Crise Metcalfe et démission des ministres", description: "La Fontaine, Baldwin et presque tout le Conseil exécutif démissionnent lorsque le gouverneur refuse de suivre l’avis de ses ministres.", imageUrl: "/documents/acte-union/parlement-canada-montreal-interieur.jpg", imageAlt: "Aquarelle montrant l’intérieur de la Chambre de l’Assemblée législative de la Province du Canada à Montréal vers 1848", credit: "James Duncan, vers 1848 · domaine public", sourceUrl: "https://commons.wikimedia.org/wiki/File:Parlement_Canada_Montr%C3%A9al_int%C3%A9rieur.jpg" },
